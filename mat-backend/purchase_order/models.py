...
class CustomerPurchaseOrder(models.Model):
    ...
    quantity = models.DecimalField(max_digits=14, decimal_places=3, blank=True, null=True)  # max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    unit_price = models.DecimalField(max_digits=14, decimal_places=3, blank=True, null=True)  # max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    uom = models.TextField(blank=True, null=True)
    hsn_sac = models.TextField(blank=True, null=True)
    total_price = models.DecimalField(max_digits=14, decimal_places=3, blank=True, null=True)  # max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    qty_balance = models.DecimalField(max_digits=14, decimal_places=3, blank=True, null=True)  # max_digits and decimal_places have been guessed, as this database handles decimal fields as float
